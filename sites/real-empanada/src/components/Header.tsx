    ...
    <header className="sticky top-0 z-50 bg-cream border-b border-muted/30 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          {/* Social icons */}
          <div className="flex items-center gap-3 pl-2 border-l border-muted/30">
            <a
              href="https://www.instagram.com/realempanadaco/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-body/60 hover:text-primary transition-colors"
      ...
      {mobileOpen && (
        <div className="md:hidden bg-cream border-t border-muted/30 px-4 pb-4">
          ...
          <div className="flex items-center gap-4 py-3 border-b border-muted/20">
            <a
              href="https://www.instagram.com/realempanadaco/"
              target="_blank"
              rel="noopener noreferrer"
