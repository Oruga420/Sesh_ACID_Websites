  ...
  return (
    <footer
      style={{
        ...
        color: BRAND.colors.footerText,
      }}
    >
      <div
        className="mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12"
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed opacity-80">
            Expert hair color transformations on Kennedy Rd in Scarborough.
        ...
        <div>
          ...
          <div className="space-y-4 text-sm opacity-80">
            <div className="flex items-start gap-3">
              <span style={{ color: BRAND.colors.primary }} className="mt-0.5">
                <MapPinIcon />
              </span>
          ...
          <a
            href={`tel:${BRAND.business.phone}`}
            className="inline-block mt-6 font-body font-semibold px-6 py-3 rounded-lg transition-all hover:shadow-lg"
            style={{
      ...
      {/* Bottom bar */}
      <div
        className="border-t px-6 py-4 text-center text-xs opacity-50"
        style={{ borderTopColor: 'rgba(248,187,208,0.15)' }}
      >
        &copy; {new Date().getFullYear()} {BRAND.business.name}. All rights reserved.
      </div>
    </footer>
  );
}
