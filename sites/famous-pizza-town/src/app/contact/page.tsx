...
const contactDetails = [
  {
    label: "Address",
    value: "1947 Victoria Park Avenue\nScarborough, ON M1R 1V1",
    icon: (
  ...
  {
    label: "Email",
    value: "contact@famouspizzatown.ca",
    href: "mailto:contact@famouspizzatown.ca",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="mt-10 p-6 bg-gray-50 rounded-2xl">
                ...
                <div className="flex flex-wrap gap-3">
                  {["Uber Eats", "SkipTheDishes", "DoorDash"].map(
                    (platform) => (
                      <span
                        key={platform}
                        className="bg-white border border-gray-200 text-sm font-medium text-gray-700 px-4 py-2 rounded-lg"
                      >
                        {platform}
                      </span>
                    )
            ...
            <div>
              ...
              {/* Map Placeholder */}
              <div className="mt-8 aspect-video rounded-2xl bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-sm mb-6">
            Stay up to date with our latest deals and specials.
          </p>
          <div className="flex justify-center gap-4">
            <a
              href="https://www.facebook.com/Famous-Pizza-Town"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white border border-gray-200 rounded-xl px-6 py-3 text-sm font-medium text-gray-700 hover:border-primary-300 hover:text-primary-600 transition-colors"
            >
              Facebook
            </a>
            <a
              href="https://www.yelp.ca/biz/famous-pizza-town-toronto"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white border border-gray-200 rounded-xl px-6 py-3 text-sm font-medium text-gray-700 hover:border-primary-300 hover:text-primary-600 transition-colors"
            >
