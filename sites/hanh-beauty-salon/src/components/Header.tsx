  ...
  return (
    <header
      ...
      style={{
        ...
        boxShadow: scrolled ? "0 2px 20px rgba(107,142,123,0.1)" : "none",
        ...
        <nav className="hidden md:flex items-center gap-8">
          {NAV_LINKS.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="text-[13px] tracking-[0.15em] uppercase transition-colors duration-200 hover:opacity-80"
              style={{
          ...
          {NAV_LINKS.map((link) => (
            <Link
              ...
              style={{
                ...
                fontWeight: 500,
                borderColor: BRAND.colors.warmNeutral,
              }}
